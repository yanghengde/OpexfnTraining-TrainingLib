...
namespace Siemens.Mom.Presales.Training.MasterData.TrainingLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class AssignTeamToGroupHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return AssignTeamToGroupHandler((AssignTeamToGroup)command);
        }
        ...
        {
            return typeof(AssignTeamToGroup);
        }
    }
}
