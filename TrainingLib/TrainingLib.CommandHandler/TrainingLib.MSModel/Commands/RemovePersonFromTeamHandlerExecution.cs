...
namespace Siemens.Mom.Presales.Training.MasterData.TrainingLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class RemovePersonFromTeamHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return RemovePersonFromTeamHandler((RemovePersonFromTeam)command);
        }
        ...
        {
            return typeof(RemovePersonFromTeam);
        }
    }
}
